const SKILLS = {
  Frontend: ['React', 'TypeScript', 'JavaScript', 'Vue', 'React Router', 'HTML/CSS'],
  Backend: ['Node.js', 'C#', 'ASP.NET', 'Ruby on Rails'],
  'Data & Analytics': ['Python', 'Pandas', 'PySpark', 'Matplotlib', 'Seaborn', 'Tableau', 'SQL'],
...
export default function Skills() {
  return (
    <section id="skills" style={{ padding: '80px 2.5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '14px', maxWidth: '780px' }}>
        {Object.entries(SKILLS).map(([category, items]) => (
          <div key={category} style={{
            ...
            <p style={{ fontSize: '11px', color: '#6366f1', fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '12px' }}>
              {category}
            </p>
